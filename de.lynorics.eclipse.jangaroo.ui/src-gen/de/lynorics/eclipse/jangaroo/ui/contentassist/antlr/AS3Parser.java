		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInterfaceMethodAccess().getAlternatives_3(), "rule__InterfaceMethod__Alternatives_3");
					put(grammarAccess.getInterfaceMethodAccess().getAlternatives_6_1(), "rule__InterfaceMethod__Alternatives_6_1");
					...
					put(grammarAccess.getMethodAccess().getAlternatives_7_1(), "rule__Method__Alternatives_7_1");
					put(grammarAccess.getMethodAccess().getAlternatives_8(), "rule__Method__Alternatives_8");
					...
					put(grammarAccess.getInterfaceMethodAccess().getGroup_3_0(), "rule__InterfaceMethod__Group_3_0__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_3_1(), "rule__InterfaceMethod__Group_3_1__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_4(), "rule__InterfaceMethod__Group_4__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_4_1(), "rule__InterfaceMethod__Group_4_1__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_6(), "rule__InterfaceMethod__Group_6__0");
					...
					put(grammarAccess.getDirectiveAccess().getAnnotationAssignment_1_0(), "rule__Directive__AnnotationAssignment_1_0");
					...
					put(grammarAccess.getInterfaceMethodAccess().getAnnonAssignment_0(), "rule__InterfaceMethod__AnnonAssignment_0");
					put(grammarAccess.getInterfaceMethodAccess().getModifierAssignment_1(), "rule__InterfaceMethod__ModifierAssignment_1");
					put(grammarAccess.getInterfaceMethodAccess().getNameAssignment_3_0_0(), "rule__InterfaceMethod__NameAssignment_3_0_0");
					put(grammarAccess.getInterfaceMethodAccess().getAccessorAssignment_3_1_0(), "rule__InterfaceMethod__AccessorAssignment_3_1_0");
					put(grammarAccess.getInterfaceMethodAccess().getNameAssignment_3_1_1(), "rule__InterfaceMethod__NameAssignment_3_1_1");
					put(grammarAccess.getInterfaceMethodAccess().getParamsAssignment_4_0(), "rule__InterfaceMethod__ParamsAssignment_4_0");
					put(grammarAccess.getInterfaceMethodAccess().getParamsAssignment_4_1_1(), "rule__InterfaceMethod__ParamsAssignment_4_1_1");
					put(grammarAccess.getInterfaceMethodAccess().getTypeAssignment_6_1_2(), "rule__InterfaceMethod__TypeAssignment_6_1_2");
					put(grammarAccess.getInterfaceMethodAccess().getTypeAssignment_6_1_3(), "rule__InterfaceMethod__TypeAssignment_6_1_3");
					put(grammarAccess.getClassAccess().getAnnonAssignment_0(), "rule__Class__AnnonAssignment_0");
					...
					put(grammarAccess.getMethodAccess().getAnnonAssignment_0(), "rule__Method__AnnonAssignment_0");
					put(grammarAccess.getMethodAccess().getModifierAssignment_2(), "rule__Method__ModifierAssignment_2");
					put(grammarAccess.getMethodAccess().getNameAssignment_4_0_0(), "rule__Method__NameAssignment_4_0_0");
					put(grammarAccess.getMethodAccess().getAccessorAssignment_4_1_0(), "rule__Method__AccessorAssignment_4_1_0");
					put(grammarAccess.getMethodAccess().getNameAssignment_4_1_1(), "rule__Method__NameAssignment_4_1_1");
					...
					put(grammarAccess.getMethodAccess().getTypeAssignment_7_1_2(), "rule__Method__TypeAssignment_7_1_2");
					put(grammarAccess.getMethodAccess().getTypeAssignment_7_1_3(), "rule__Method__TypeAssignment_7_1_3");
					put(grammarAccess.getMethodAccess().getBodyAssignment_8_0(), "rule__Method__BodyAssignment_8_0");
					...
					put(grammarAccess.getVariableDeclarationAccess().getTypeAssignment_5_2(), "rule__VariableDeclaration__TypeAssignment_5_2");
					put(grammarAccess.getVariableDeclarationAccess().getTypeAssignment_5_3(), "rule__VariableDeclaration__TypeAssignment_5_3");
