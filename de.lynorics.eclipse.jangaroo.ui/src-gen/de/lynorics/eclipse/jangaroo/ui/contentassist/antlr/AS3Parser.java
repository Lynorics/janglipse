		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_2(), "rule__TerminalExpression__SymbolAssignment_7_1_2");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_3(), "rule__TerminalExpression__SymbolAssignment_7_1_3");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_4(), "rule__TerminalExpression__SymbolAssignment_7_1_4");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_5(), "rule__TerminalExpression__SymbolAssignment_7_1_5");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_6(), "rule__TerminalExpression__SymbolAssignment_7_1_6");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_7_1_7(), "rule__TerminalExpression__SymbolAssignment_7_1_7");
