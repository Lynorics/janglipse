		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMemberVariableDeclarationAccess().getAlternatives_2(), "rule__MemberVariableDeclaration__Alternatives_2");
					put(grammarAccess.getMemberVariableDeclarationAccess().getAlternatives_4_1(), "rule__MemberVariableDeclaration__Alternatives_4_1");
					...
					put(grammarAccess.getTerminalExpressionAccess().getAlternatives_8_1(), "rule__TerminalExpression__Alternatives_8_1");
					...
					put(grammarAccess.getMemberVariableDeclarationAccess().getGroup_4(), "rule__MemberVariableDeclaration__Group_4__0");
					put(grammarAccess.getMemberVariableDeclarationAccess().getGroup_5(), "rule__MemberVariableDeclaration__Group_5__0");
					...
					put(grammarAccess.getUsesAccess().getAnytypeAssignment_3_1(), "rule__Uses__AnytypeAssignment_3_1");
					put(grammarAccess.getUsesAccess().getAnytypeAssignment_3_2(), "rule__Uses__AnytypeAssignment_3_2");
					...
					put(grammarAccess.getInterfaceMethodAccess().getAnytypeAssignment_2_4_1_0(), "rule__InterfaceMethod__AnytypeAssignment_2_4_1_0");
					put(grammarAccess.getInterfaceMethodAccess().getAnytypeAssignment_2_4_1_1(), "rule__InterfaceMethod__AnytypeAssignment_2_4_1_1");
					...
					put(grammarAccess.getClassAccess().getSuperclassAssignment_2_2_1(), "rule__Class__SuperclassAssignment_2_2_1");
					...
					put(grammarAccess.getAccessorRoleAccess().getAccessorAssignment(), "rule__AccessorRole__AccessorAssignment");
					...
					put(grammarAccess.getMethodAccess().getAnytypeAssignment_3_4_1_0(), "rule__Method__AnytypeAssignment_3_4_1_0");
					put(grammarAccess.getMethodAccess().getAnytypeAssignment_3_4_1_1(), "rule__Method__AnytypeAssignment_3_4_1_1");
					...
					put(grammarAccess.getMemberVariableDeclarationAccess().getAnnotationsAssignment_0(), "rule__MemberVariableDeclaration__AnnotationsAssignment_0");
					put(grammarAccess.getMemberVariableDeclarationAccess().getModifierAssignment_1(), "rule__MemberVariableDeclaration__ModifierAssignment_1");
					put(grammarAccess.getMemberVariableDeclarationAccess().getNameAssignment_3(), "rule__MemberVariableDeclaration__NameAssignment_3");
					put(grammarAccess.getMemberVariableDeclarationAccess().getAnytypeAssignment_4_1_0(), "rule__MemberVariableDeclaration__AnytypeAssignment_4_1_0");
					put(grammarAccess.getMemberVariableDeclarationAccess().getAnytypeAssignment_4_1_1(), "rule__MemberVariableDeclaration__AnytypeAssignment_4_1_1");
					put(grammarAccess.getMemberVariableDeclarationAccess().getTypeAssignment_4_1_2(), "rule__MemberVariableDeclaration__TypeAssignment_4_1_2");
					put(grammarAccess.getMemberVariableDeclarationAccess().getTypeAssignment_4_1_3(), "rule__MemberVariableDeclaration__TypeAssignment_4_1_3");
					put(grammarAccess.getMemberVariableDeclarationAccess().getExpressionAssignment_5_1(), "rule__MemberVariableDeclaration__ExpressionAssignment_5_1");
					put(grammarAccess.getVariableDeclarationAccess().getNameAssignment_1(), "rule__VariableDeclaration__NameAssignment_1");
					put(grammarAccess.getVariableDeclarationAccess().getAnytypeAssignment_2_1_0(), "rule__VariableDeclaration__AnytypeAssignment_2_1_0");
					put(grammarAccess.getVariableDeclarationAccess().getAnytypeAssignment_2_1_1(), "rule__VariableDeclaration__AnytypeAssignment_2_1_1");
					...
					put(grammarAccess.getParameterAccess().getAnytypeAssignment_3_1_0(), "rule__Parameter__AnytypeAssignment_3_1_0");
					put(grammarAccess.getParameterAccess().getAnytypeAssignment_3_1_1(), "rule__Parameter__AnytypeAssignment_3_1_1");
					...
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_0(), "rule__TerminalExpression__SymbolAssignment_8_1_0");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_1(), "rule__TerminalExpression__SymbolAssignment_8_1_1");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_2(), "rule__TerminalExpression__SymbolAssignment_8_1_2");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_3(), "rule__TerminalExpression__SymbolAssignment_8_1_3");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_4(), "rule__TerminalExpression__SymbolAssignment_8_1_4");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_5(), "rule__TerminalExpression__SymbolAssignment_8_1_5");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_6(), "rule__TerminalExpression__SymbolAssignment_8_1_6");
					put(grammarAccess.getTerminalExpressionAccess().getSymbolAssignment_8_1_7(), "rule__TerminalExpression__SymbolAssignment_8_1_7");
