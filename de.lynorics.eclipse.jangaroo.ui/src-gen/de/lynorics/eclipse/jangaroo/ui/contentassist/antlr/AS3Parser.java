		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMethodAccess().getAlternatives_7(), "rule__Method__Alternatives_7");
					...
					put(grammarAccess.getVarOrConstAccess().getAlternatives(), "rule__VarOrConst__Alternatives");
					...
					put(grammarAccess.getDirectiveAccess().getGroup_1_0_2(), "rule__Directive__Group_1_0_2__0");
					...
					put(grammarAccess.getInterfaceMethodAccess().getGroup_2_0(), "rule__InterfaceMethod__Group_2_0__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_2_1(), "rule__InterfaceMethod__Group_2_1__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_3(), "rule__InterfaceMethod__Group_3__0");
					put(grammarAccess.getInterfaceMethodAccess().getGroup_3_1(), "rule__InterfaceMethod__Group_3_1__0");
					...
					put(grammarAccess.getStatementAccess().getGroup_1_17(), "rule__Statement__Group_1_17__0");
					...
					put(grammarAccess.getDeclarationTailAccess().getGroup(), "rule__DeclarationTail__Group__0");
					put(grammarAccess.getDeclarationTailAccess().getGroup_1(), "rule__DeclarationTail__Group_1__0");
					put(grammarAccess.getVariableInitializerAccess().getGroup(), "rule__VariableInitializer__Group__0");
					...
					put(grammarAccess.getDirectiveAccess().getNameAssignment_1_0_1(), "rule__Directive__NameAssignment_1_0_1");
					put(grammarAccess.getDirectiveAccess().getAnnonFieldsAssignment_1_0_2_1(), "rule__Directive__AnnonFieldsAssignment_1_0_2_1");
					put(grammarAccess.getDirectiveAccess().getUsesAssignment_1_1(), "rule__Directive__UsesAssignment_1_1");
					...
					put(grammarAccess.getInterfaceMethodAccess().getModifierAssignment_0(), "rule__InterfaceMethod__ModifierAssignment_0");
					put(grammarAccess.getInterfaceMethodAccess().getNameAssignment_2_0_0(), "rule__InterfaceMethod__NameAssignment_2_0_0");
					put(grammarAccess.getInterfaceMethodAccess().getAccessorAssignment_2_1_0(), "rule__InterfaceMethod__AccessorAssignment_2_1_0");
					put(grammarAccess.getInterfaceMethodAccess().getNameAssignment_2_1_1(), "rule__InterfaceMethod__NameAssignment_2_1_1");
					put(grammarAccess.getInterfaceMethodAccess().getParamsAssignment_3_0(), "rule__InterfaceMethod__ParamsAssignment_3_0");
					put(grammarAccess.getInterfaceMethodAccess().getParamsAssignment_3_1_1(), "rule__InterfaceMethod__ParamsAssignment_3_1_1");
					put(grammarAccess.getInterfaceMethodAccess().getTypeAssignment_5_1(), "rule__InterfaceMethod__TypeAssignment_5_1");
					...
					put(grammarAccess.getClassAccess().getTypesAssignment_4_1(), "rule__Class__TypesAssignment_4_1");
					put(grammarAccess.getClassAccess().getTypesAssignment_4_2_1(), "rule__Class__TypesAssignment_4_2_1");
					...
					put(grammarAccess.getMethodAccess().getModifierAssignment_1(), "rule__Method__ModifierAssignment_1");
					put(grammarAccess.getMethodAccess().getNameAssignment_3_0_0(), "rule__Method__NameAssignment_3_0_0");
					put(grammarAccess.getMethodAccess().getAccessorAssignment_3_1_0(), "rule__Method__AccessorAssignment_3_1_0");
					put(grammarAccess.getMethodAccess().getNameAssignment_3_1_1(), "rule__Method__NameAssignment_3_1_1");
					...
					put(grammarAccess.getMethodAccess().getTypeAssignment_6_1(), "rule__Method__TypeAssignment_6_1");
					put(grammarAccess.getMethodAccess().getBodyAssignment_7_0(), "rule__Method__BodyAssignment_7_0");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getSuperExprAssignment_1_2_1_1(), "rule__PrimaryExpression__SuperExprAssignment_1_2_1_1");
					put(grammarAccess.getPrimaryExpressionAccess().getConAssignment_1_3(), "rule__PrimaryExpression__ConAssignment_1_3");
					put(grammarAccess.getPrimaryExpressionAccess().getLitAssignment_1_4(), "rule__PrimaryExpression__LitAssignment_1_4");
					put(grammarAccess.getPrimaryExpressionAccess().getLitAssignment_1_5(), "rule__PrimaryExpression__LitAssignment_1_5");
					put(grammarAccess.getPrimaryExpressionAccess().getFexprAssignment_1_6(), "rule__PrimaryExpression__FexprAssignment_1_6");
					put(grammarAccess.getPrimaryExpressionAccess().getNexprAssignment_1_7(), "rule__PrimaryExpression__NexprAssignment_1_7");
					put(grammarAccess.getPrimaryExpressionAccess().getEncexprAssignment_1_8(), "rule__PrimaryExpression__EncexprAssignment_1_8");
					put(grammarAccess.getPrimaryExpressionAccess().getE4xAssignment_1_9(), "rule__PrimaryExpression__E4xAssignment_1_9");
					put(grammarAccess.getPrimaryExpressionAccess().getQualAssignment_1_10(), "rule__PrimaryExpression__QualAssignment_1_10");
					put(grammarAccess.getPropOrIdentAccess().getPropIdAssignment_1(), "rule__PropOrIdent__PropIdAssignment_1");
					put(grammarAccess.getConstantAccess().getXmlAssignment_1_0(), "rule__Constant__XmlAssignment_1_0");
					put(grammarAccess.getConstantAccess().getRegexAssignment_1_1(), "rule__Constant__RegexAssignment_1_1");
					put(grammarAccess.getConstantAccess().getNumberAssignment_1_2(), "rule__Constant__NumberAssignment_1_2");
					put(grammarAccess.getConstantAccess().getStringAssignment_1_3(), "rule__Constant__StringAssignment_1_3");
					...
					put(grammarAccess.getTypeExpressionAccess().getIdentiAssignment_2_0(), "rule__TypeExpression__IdentiAssignment_2_0");
					...
					put(grammarAccess.getStatementAccess().getSbAssignment_1_0(), "rule__Statement__SbAssignment_1_0");
					put(grammarAccess.getStatementAccess().getSdsAssignment_1_1(), "rule__Statement__SdsAssignment_1_1");
					put(grammarAccess.getStatementAccess().getSesAssignment_1_2(), "rule__Statement__SesAssignment_1_2");
					put(grammarAccess.getStatementAccess().getSisAssignment_1_3(), "rule__Statement__SisAssignment_1_3");
					put(grammarAccess.getStatementAccess().getSfesAssignment_1_4(), "rule__Statement__SfesAssignment_1_4");
					put(grammarAccess.getStatementAccess().getSfsAssignment_1_5(), "rule__Statement__SfsAssignment_1_5");
					put(grammarAccess.getStatementAccess().getSwsAssignment_1_6(), "rule__Statement__SwsAssignment_1_6");
					put(grammarAccess.getStatementAccess().getSdwsAssignment_1_7(), "rule__Statement__SdwsAssignment_1_7");
					put(grammarAccess.getStatementAccess().getWsAssignment_1_8(), "rule__Statement__WsAssignment_1_8");
					put(grammarAccess.getStatementAccess().getSssAssignment_1_9(), "rule__Statement__SssAssignment_1_9");
					put(grammarAccess.getStatementAccess().getSbsAssignment_1_10(), "rule__Statement__SbsAssignment_1_10");
					put(grammarAccess.getStatementAccess().getScsAssignment_1_11(), "rule__Statement__ScsAssignment_1_11");
					put(grammarAccess.getStatementAccess().getSrsAssignment_1_12(), "rule__Statement__SrsAssignment_1_12");
					put(grammarAccess.getStatementAccess().getStsAssignment_1_13(), "rule__Statement__StsAssignment_1_13");
					put(grammarAccess.getStatementAccess().getTsAssignment_1_14(), "rule__Statement__TsAssignment_1_14");
					put(grammarAccess.getStatementAccess().getSdxnsAssignment_1_15(), "rule__Statement__SdxnsAssignment_1_15");
					put(grammarAccess.getStatementAccess().getAssertAssignment_1_17_1(), "rule__Statement__AssertAssignment_1_17_1");
					put(grammarAccess.getVariableDeclaratorAccess().getTypeAssignment_1(), "rule__VariableDeclarator__TypeAssignment_1");
					put(grammarAccess.getVariableDeclaratorAccess().getVarAssignment_2(), "rule__VariableDeclarator__VarAssignment_2");
					put(grammarAccess.getDeclarationAccess().getTailAssignment_2(), "rule__Declaration__TailAssignment_2");
					put(grammarAccess.getDeclarationTailAccess().getVarAssignment_1_1(), "rule__DeclarationTail__VarAssignment_1_1");
					put(grammarAccess.getVariableInitializerAccess().getExprAssignment_1(), "rule__VariableInitializer__ExprAssignment_1");
