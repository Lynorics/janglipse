...
public class AS3SyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_VarType_AsteriskKeyword_1_or_VoidKeyword_0;
	...
	protected void init(IGrammarAccess access) {
		...
		match_VarType_AsteriskKeyword_1_or_VoidKeyword_0 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getVarTypeAccess().getAsteriskKeyword_1()), new TokenAlias(false, false, grammarAccess.getVarTypeAccess().getVoidKeyword_0()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_VarType_AsteriskKeyword_1_or_VoidKeyword_0.equals(syntax))
				emit_VarType_AsteriskKeyword_1_or_VoidKeyword_0(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     '*' | 'void'
	 */
	protected void emit_VarType_AsteriskKeyword_1_or_VoidKeyword_0(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
