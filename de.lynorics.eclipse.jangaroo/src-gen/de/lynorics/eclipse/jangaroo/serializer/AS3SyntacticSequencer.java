...
public class AS3SyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Method___GetKeyword_3_0_or_SetKeyword_3_1__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Method___GetKeyword_3_0_or_SetKeyword_3_1__q = new AlternativeAlias(false, true, new TokenAlias(false, false, grammarAccess.getMethodAccess().getGetKeyword_3_0()), new TokenAlias(false, false, grammarAccess.getMethodAccess().getSetKeyword_3_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Method___GetKeyword_3_0_or_SetKeyword_3_1__q.equals(syntax))
				emit_Method___GetKeyword_3_0_or_SetKeyword_3_1__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('set' | 'get')?
	 */
	protected void emit_Method___GetKeyword_3_0_or_SetKeyword_3_1__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
