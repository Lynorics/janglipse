 ...
 * <ul>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.additiveExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.additiveExpressionImpl#getO <em>O</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class additiveExpressionImpl extends MinimalEObjectImpl.Container implements additiveExpression
{
  ...
  {
    return AS3Package.Literals.ADDITIVE_EXPRESSION;
  }
  ...
  public EList<multiplicativeExpression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<multiplicativeExpression>(multiplicativeExpression.class, this, AS3Package.ADDITIVE_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getO()
  {
    if (o == null)
    {
      o = new EDataTypeEList<String>(String.class, this, AS3Package.ADDITIVE_EXPRESSION__O);
    }
    return o;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AS3Package.ADDITIVE_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AS3Package.ADDITIVE_EXPRESSION__EXPR:
        return getExpr();
      case AS3Package.ADDITIVE_EXPRESSION__O:
        return getO();
    }
