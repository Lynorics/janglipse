 ...
 * <ul>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.qualifierImpl#getLevel <em>Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class qualifierImpl extends MinimalEObjectImpl.Container implements qualifier
{
  ...
  {
    return AS3Package.Literals.QUALIFIER;
  }
  ...
  public void setLevel(AccessLevel newLevel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AS3Package.QUALIFIER__LEVEL, oldLevel, level));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AS3Package.QUALIFIER__LEVEL:
        return getLevel();
    }
