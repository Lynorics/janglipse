 ...
 * <ul>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.equalityExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.equalityExpressionImpl#getO <em>O</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class equalityExpressionImpl extends MinimalEObjectImpl.Container implements equalityExpression
{
  ...
  {
    return AS3Package.Literals.EQUALITY_EXPRESSION;
  }
  ...
  public EList<relationalExpression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<relationalExpression>(relationalExpression.class, this, AS3Package.EQUALITY_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getO()
  {
    if (o == null)
    {
      o = new EDataTypeEList<String>(String.class, this, AS3Package.EQUALITY_EXPRESSION__O);
    }
    return o;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AS3Package.EQUALITY_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AS3Package.EQUALITY_EXPRESSION__EXPR:
        return getExpr();
      case AS3Package.EQUALITY_EXPRESSION__O:
        return getO();
    }
