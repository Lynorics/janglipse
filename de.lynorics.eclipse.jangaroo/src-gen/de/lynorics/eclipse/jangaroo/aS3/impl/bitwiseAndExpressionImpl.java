 ...
 * <ul>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.bitwiseAndExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.lynorics.eclipse.jangaroo.aS3.impl.bitwiseAndExpressionImpl#getO <em>O</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class bitwiseAndExpressionImpl extends MinimalEObjectImpl.Container implements bitwiseAndExpression
{
  ...
  {
    return AS3Package.Literals.BITWISE_AND_EXPRESSION;
  }
  ...
  public EList<equalityExpression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<equalityExpression>(equalityExpression.class, this, AS3Package.BITWISE_AND_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getO()
  {
    if (o == null)
    {
      o = new EDataTypeEList<String>(String.class, this, AS3Package.BITWISE_AND_EXPRESSION__O);
    }
    return o;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AS3Package.BITWISE_AND_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AS3Package.BITWISE_AND_EXPRESSION__EXPR:
        return getExpr();
      case AS3Package.BITWISE_AND_EXPRESSION__O:
        return getO();
    }
